...
namespace Myvshoponline.Controllers
{
    public class PositionsController : Controller
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "ID,Position1,Description,Status")] Position position)
        {
        ...
        //[ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "ID,Position1,Description,Status")] Position position)
        {
            if (ModelState.IsValid)
            {
